...
//   if (mySensor.begin(ACaddress) == false) //Initialize sensor using I2C address 0x60
//   {
...
//     // Variablen deklarieren, um die Ergebnisse zu speichern
//     float apparentPower, powerFactor;
//     bool isAnglePositive, isPowerFactorPositive; // Diese Variable wird den POSPF-Wert enthalten

//     // Die Funktion aufrufen, die das Register 0x22 liest und die Bits extrahiert
//     if (mySensor.readPowerFactor(&apparentPower, &powerFactor, &isAnglePositive, &isPowerFactorPositive) == ACS37800_SUCCESS)
//     {
//         Serial.println();
//         Serial.print(F("--- Power Factor Details ---"));
//         Serial.println();
//         Serial.print(F("POSPF (isPowerFactorPositive): "));
        
//         // Den Wert des POSPF-Bits ausgeben
//         if (isPowerFactorPositive) 
//         {
//             Serial.println(F("1 (Power is being consumed)"));
//         }
//         else
//         {
//             Serial.println(F("0 (Power is being generated/returned)"));
//         }
        
//         Serial.print(F("Apparent Power: ")); Serial.print(apparentPower); Serial.println(F(" VA"));
//         Serial.print(F("Power Factor: ")); Serial.println(powerFactor);
//     }
//     else
//     {
//         Serial.println(F("Could not read power factor data."));
//     }
