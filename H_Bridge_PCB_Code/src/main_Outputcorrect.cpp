...
// static OutputMeasurements ch1_om(/*osr*/ OM_OSR, /*fs_mv*/ OM_FS_MV*121.0f, /*init bitrate*/ (float)F_CLK_HZ);
// static OutputMeasurements ch2_om(/*osr*/ OM_OSR, /*fs_mv*/ OM_FS_MV*10.0f, /*init bitrate*/ (float)F_CLK_HZ);
...
//   static float outBuf[7]; // [0]=ch1_freq, [1]=ch1_rms_mV, [2]=ch2_freq, [3]=ch2_rms_mV, rest reserved
...
//                           6144, &ch2_om, 3, &analyzer2Handle, 1);
